let chalk,atomIndexTemplate,atomStylesTemplate,atomTestTemplate,atomStoriesTemplate,fs;_ef1‍.x([["generateAtom",()=>generateAtom]]);_ef1‍.w("chalk",[["default",["chalk"],function(v){chalk=v}]]);_ef1‍.w("../templates/atom",[["atomIndexTemplate",["atomIndexTemplate"],function(v){atomIndexTemplate=v}],["atomStylesTemplate",["atomStylesTemplate"],function(v){atomStylesTemplate=v}],["atomTestTemplate",["atomTestTemplate"],function(v){atomTestTemplate=v}],["atomStoriesTemplate",["atomStoriesTemplate"],function(v){atomStoriesTemplate=v}]]);_ef1‍.w("fs",[["default",["fs"],function(v){fs=v}]]);
...
// }
  ...
  if (options.name === null) {
    _ef1‍.g.console.log('%s No atom name given, exiting.', chalk.yellow.bold('FAILED'))
    return true
  }
    ...
    const updateIndex = index => {
      ...
      fs.readFile(index, 'utf8', function (err, data) {
        ...
        fs.writeFile(index, result_cleaned, 'utf8', function (err) {
          if (err) return _ef1‍.g.console.log(err)
        })
      })
    }
  ...
  _ef1‍.g.console.log('%s Atom created', chalk.green.bold('DONE'))
  return true
}
